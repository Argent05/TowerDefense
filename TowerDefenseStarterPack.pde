...
//Buttons
Button start, nextwave, build,play, fourshootButton;
...
//Images and Gifs
Gif introAnimation,tower1,movetower1;
PImage arrowhead, fourshoot;
//Fonts
PFont basic;
...
void makeButtons() {
  ...
  build = new Button("BUILD", width-83, 220,120,90,green,white);
 
  //BUILD - To play mode, Buy Sniper, Buy Gun, Buy AoE
 play = new Button("PLAY", width-83,120,120,90,green,white);
 fourshootButton = new Button(fourshoot, width-83, 220,120,90,green,white);
  //GAMEOVER - Reset
}
